 ...
 *             method {@link android.bytewebkit.CookieManager#flush} which is a synchronous
 *             replacement for {@link #sync}.
 */
@Deprecated
public final class CookieSyncManager extends android.bytewebkit.WebSyncManager {
     ...
     * @deprecated Use {@link android.bytewebkit.CookieManager#flush} instead.
     */
    @Deprecated
    public void sync() {
        android.bytewebkit.CookieManager.getInstance().flush();
    }
