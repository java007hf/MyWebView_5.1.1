...
public class GeolocationPermissions {
     ...
     * called before the application instantiates a {@link android.bytewebkit.WebView} instance.
     *
     ...
     *
     * @param callback a {@link android.bytewebkit.ValueCallback} to receive the result of this
     *                 request. This object's
     *                 {@link android.bytewebkit.ValueCallback#onReceiveValue(T) onReceiveValue()}
    ...
    // on this string.
    public void getOrigins(android.bytewebkit.ValueCallback<Set<String> > callback) {
     ...
     *                 Geolocation API.
     */
    public void getAllowed(String origin, android.bytewebkit.ValueCallback<Boolean> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
