...
public class JsDialogHelper {
    ...
    public boolean invokeCallback(android.bytewebkit.WebChromeClient client, android.bytewebkit.WebView webView) {
        switch (mType) {
            case ALERT:
    ...
    private String getJsDialogTitle(Context context) {
        String title = mUrl;
        if (android.bytewebkit.URLUtil.isDataUrl(mUrl)) {
