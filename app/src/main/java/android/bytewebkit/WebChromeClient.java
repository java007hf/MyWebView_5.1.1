...
public class WebChromeClient {
     ...
     */
    public void onProgressChanged(android.bytewebkit.WebView view, int newProgress) {}
     ...
     */
    public void onReceivedTitle(android.bytewebkit.WebView view, String title) {}
     ...
     */
    public void onReceivedIcon(android.bytewebkit.WebView view, Bitmap icon) {}
     ...
     */
    public void onReceivedTouchIconUrl(android.bytewebkit.WebView view, String url,
                                       boolean precomposed) {}
     ...
     * {@link android.bytewebkit.WebView}.
     ...
     *                  {@link android.bytewebkit.WebView.WebViewTransport} object. This should be
     *                  used to transport the new WebView, by calling
     *                  {@link android.bytewebkit.WebView.WebViewTransport#setWebView(android.bytewebkit.WebView)
     ...
     *         undefined behavior.
     */
    public boolean onCreateWindow(android.bytewebkit.WebView view, boolean isDialog,
     ...
     */
    public void onRequestFocus(android.bytewebkit.WebView view) {}
     ...
     */
    public void onCloseWindow(android.bytewebkit.WebView window) {}
     ...
     */
    public boolean onJsAlert(android.bytewebkit.WebView view, String url, String message,
                             android.bytewebkit.JsResult result) {
        return false;
    }
     ...
     */
    public boolean onJsConfirm(android.bytewebkit.WebView view, String url, String message,
                               android.bytewebkit.JsResult result) {
        return false;
    }
     ...
     */
    public boolean onJsPrompt(android.bytewebkit.WebView view, String url, String message,
     ...
     * @return boolean Whether the client will handle the confirm dialog.
     */
    public boolean onJsBeforeUnload(android.bytewebkit.WebView view, String url, String message,
                                    android.bytewebkit.JsResult result) {
        return false;
    }
    ...
    * {@link android.bytewebkit.WebStorage.QuotaUpdater#updateQuota(long) updateQuota(long)}
    * method of the supplied {@link android.bytewebkit.WebStorage.QuotaUpdater} instance. The
    ...
    * @param quotaUpdater An instance of {@link android.bytewebkit.WebStorage.QuotaUpdater} which
    ...
    */
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier,
            ...
            android.bytewebkit.WebStorage.QuotaUpdater quotaUpdater) {
    ...
    */
     ...
     * {@link android.bytewebkit.GeolocationPermissions} for details.
    ...
    public void onGeolocationPermissionsShowPrompt(String origin,
            android.bytewebkit.GeolocationPermissions.Callback callback) {}

    /**
     * Notify the host application that a request for Geolocation permissions,
     * made with a previous call to
     * {@link #onGeolocationPermissionsShowPrompt(String, android.bytewebkit.GeolocationPermissions.Callback) onGeolocationPermissionsShowPrompt()}
     ...
     * or denied. The host application must invoke {@link android.bytewebkit.PermissionRequest#grant(String[])}
     * or {@link android.bytewebkit.PermissionRequest#deny()}.
     *
     * If this method isn't overridden, the permission is denied.
     *
     * @param request the PermissionRequest from current web content.
     */
    public void onPermissionRequest(android.bytewebkit.PermissionRequest request) {
        request.deny();
    }
     ...
     */
    public void onPermissionRequestCanceled(android.bytewebkit.PermissionRequest request) {}
     ...
     * @deprecated Use {@link #onConsoleMessage(android.bytewebkit.ConsoleMessage) onConsoleMessage(ConsoleMessage)}
     *      instead.
     */
    @Deprecated
     ...
     */
    public boolean onConsoleMessage(android.bytewebkit.ConsoleMessage consoleMessage) {
     ...
     */
    public void getVisitedHistory(android.bytewebkit.ValueCallback<String[]> callback) {
    }
     ...
     */
    public boolean onShowFileChooser(android.bytewebkit.WebView webView, android.bytewebkit.ValueCallback<Uri[]> filePathCallback,
    ...
    public static abstract class FileChooserParams {
        ...
        public static Uri[] parseResult(int resultCode, Intent data) {
            return android.bytewebkit.WebViewFactory.getProvider().getStatics().parseFileChooserResult(resultCode, data);
        }
    ...
    @SystemApi
    @Deprecated
    public void openFileChooser(android.bytewebkit.ValueCallback<Uri> uploadFile, String acceptType, String capture) {
