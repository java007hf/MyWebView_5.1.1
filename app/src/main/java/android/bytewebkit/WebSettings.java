...
public abstract class WebSettings {
     ...
     * affect zooming performed using the {@link android.bytewebkit.WebView#zoomIn()} and
     * {@link android.bytewebkit.WebView#zoomOut()} methods. The default is true.
     *
     ...
     * tag. For pages lacking the tag, {@link android.bytewebkit.WebView#setInitialScale}
     ...
     * true, {@link android.bytewebkit.WebChromeClient#onCreateWindow} must be implemented by the
     ...
     * {@link android.bytewebkit.WebView#reload} is called.
     ...
     *             network
     * @see android.bytewebkit.WebView#reload
     */
     ...
     *   {@link android.bytewebkit.WebChromeClient#onGeolocationPermissionsShowPrompt} callback
    ...
    public static String getDefaultUserAgent(Context context) {
        return android.bytewebkit.WebViewFactory.getProvider().getStatics().getDefaultUserAgent(context);
    }

    /**
     * Tells the WebView whether it needs to set a node to have focus when
     * {@link android.bytewebkit.WebView#requestFocus(int, android.graphics.Rect)} is called. The
