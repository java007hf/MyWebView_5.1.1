...
public class WebStorage {
     ...
     * See
     * {@link android.bytewebkit.WebChromeClient#onExceededDatabaseQuota} and
     * {@link android.bytewebkit.WebChromeClient#onReachedMaxAppCacheSize}.
     ...
     * being provided via a {@link android.bytewebkit.ValueCallback}. The origins are provided as
     ...
     */
    public void getOrigins(android.bytewebkit.ValueCallback<Map> callback) {
     ...
     * a {@link android.bytewebkit.ValueCallback}.
     */
    public void getUsageForOrigin(String origin, android.bytewebkit.ValueCallback<Long> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
     ...
     * being provided via a {@link android.bytewebkit.ValueCallback}. Note that a quota is not
     * enforced on a per-origin basis for the Application Cache API.
     */
    public void getQuotaForOrigin(String origin, android.bytewebkit.ValueCallback<Long> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
    ...
    public static WebStorage getInstance() {
      return android.bytewebkit.WebViewFactory.getProvider().getWebStorage();
    }
