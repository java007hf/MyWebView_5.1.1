...
public final class WebViewFactory {
    ...
    //benylwang begin
    private static final String PLUGIN = "webview.apk";
    private static String sTempDir;
    private static final String LIB_FOLDER = "lib";
    private static final String DALVIK_CACHE_FOLDER = "dalvik-cache";
    //end
    ...
    static WebViewFactoryProvider getProvider() {
        synchronized (sProviderLock) {
            ...
            try {
                ...
                try {
                    Log.e("webview", "====begin getFactoryClass====");
                    providerClass = getFactoryClass();
                    Log.e("webview", "====after getFactoryClass====");
...
//            sPackageInfo = initialApplication.getPackageManager().getPackageArchiveInfo(WEBCORE_PATH, 0);
//            if (sPackageInfo.applicationInfo != null) {
//                sPackageInfo.applicationInfo.sourceDir = WEBCORE_PATH;
//                sPackageInfo.applicationInfo.publicSourceDir = WEBCORE_PATH;
//            }
//
...
//                          " (code " + sPackageInfo.versionCode + ")");
            ...
            //
            sTempDir = initialApplication.getExternalFilesDir(null).getAbsolutePath();
            String apkPath = sTempDir + "/" + PLUGIN;

            String apkParentDir = new File(apkPath).getParent();

            Log.e("webview", "=======apkPath = " + apkPath);
            Log.e("webview", "=======apkParentDir = " + apkParentDir);

            File optDir = new File(apkParentDir, DALVIK_CACHE_FOLDER);
            optDir.mkdirs();

            File libDir = new File(apkParentDir, LIB_FOLDER);
            libDir.mkdirs();

            initialApplication.getAssets().addAssetPath(apkPath);
            ClassLoader clazzLoader = new DexClassLoader(
                    apkPath, optDir.getAbsolutePath(), libDir.getAbsolutePath(),
